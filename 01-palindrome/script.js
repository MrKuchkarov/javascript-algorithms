...
function palindrome(str) {
    // Переводим строку в нижний регистр, чтобы игнорировать регистр букв
  str = str.toLowerCase();

  // Создаем две переменные, которые будут указывать на начало и конец строки
  let left = 0;
  let right = str.length - 1;

  // Идем по строке с двух сторон, сравнивая символы на каждой позиции
  while (left < right) {
